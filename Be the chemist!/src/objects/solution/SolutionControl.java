    ...
    protected void controlUpdate(float f) {
        ...
        for(int i=0;i<solution.getSubstances().size();i++){
            ...
            for(int j=i+1;j<solution.getSubstances().size();j++){
                ...
                //HYDROGEN AND METAL DISPLACEMENT
                ...
                //END HYDROGEN AND METAL DISPLACEMENT
        ...
        //checking if there is any negative volumes, if there are, remvoe the corresponding substances
        for(int i=0;i<solution.getVolumes().size();i++){
            
            if(solution.getVolume(i)<0){
                
                //System.out.println("SUBSTANCE:"+solution.getSubstance(i).getName()+" IN SOLUTION HAS VOLUME:"+solution.getVolume(i)+", TOTAL VOLUME VEFORE REMOVAL: "+solution.getVolume());
                
                solution.removeSubstance(i);
                
                //System.out.println("A SUBSTANCE IN SOLUTION HAS VOLUME < 0, TOTAL VOLUME AFTER REMOVAL: "+solution.getVolume());
