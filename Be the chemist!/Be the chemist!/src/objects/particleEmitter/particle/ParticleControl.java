        ...
        if(!particle.isDestroyed()){
            ...
            */
            ...
            if(!particle.isDestroyed()&&particle.getSpatial()!=null&&!particle.getMain().getParticleReceivers().isEmpty()){
                ...
                for(int i=0;i<particle.getMain().getParticleReceivers().size();i++){
                    ...
                    if(particle.getParticleEmitter().getParentObject()!=particle.getMain().getParticleReceivers().get(i)){
                        ...
                        }else if(particle.getMain().getParticleReceivers().get(i) instanceof Erlenmeyer&&!((Erlenmeyer)particle.getMain().getParticleReceivers().get(i)).isClosed()){

                            if(particle.getSpatial()!=null&&particle.getSpatial().getWorldTranslation().distance(((Erlenmeyer)particle.getMain().getParticleReceivers().get(i)).getSpatial().getWorldTranslation().add(((Erlenmeyer)particle.getMain().getParticleReceivers().get(i)).getSpatial().getLocalRotation().mult(new Vector3f(0,0.1f,0))))<0.02f){
                        ...
                        }else if(particle.getMain().getParticleReceivers().get(i) instanceof TestTube&&!((TestTube)particle.getMain().getParticleReceivers().get(i)).isClosed()){

                            System.out.println("Particle control checking erlenmeyer");
                            
                            if(particle.getSpatial()!=null&&particle.getSpatial().getWorldTranslation().distance(((TestTube)particle.getMain().getParticleReceivers().get(i)).getSpatial().getWorldTranslation().add(((TestTube)particle.getMain().getParticleReceivers().get(i)).getSpatial().getLocalRotation().mult(new Vector3f(0,0.06f,0))))<0.02f){
